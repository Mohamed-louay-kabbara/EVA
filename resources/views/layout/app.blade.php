...
<head>
  ...
  <title>EVA Website | Dashboard</title>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.20/b-1.6.1/b-colvis-1.6.1/b-html5-1.6.1/b-print-1.6.1/r-2.2.3/datatables.min.css') }}" />
  ...
  <script type="text/javascript" src="{{ asset('https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.20/b-1.6.1/b-colvis-1.6.1/b-html5-1.6.1/b-print-1.6.1/r-2.2.3/datatables.min.js') }}"></script>
  <meta charset="utf-8" />
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a class="brand-link" style="font-size:15px" href="{{ route('logout') }}" onclick="event.preventDefault();
