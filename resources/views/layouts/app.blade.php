                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @if (App::getLocale() == 'ar')
                            ...
                            <img src="{{ asset('SY.png') }}" width="40px" height="40px;" alt="">
                        @else
                            {{ LaravelLocalization::getCurrentLocaleName() }}
                            <img src="{{ URL::asset('USA.svg') }}" width="40px" height="40px;" alt="">
                        @endif
                    </button>
                    <ul class="dropdown-menu">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <a class="nav-item nav-link" style="font-size:17px;font-weight:bold"
                                class="nav-item nav-link is-submenu-item is-dropdown-submenu-item"
                                lang="{{ $localeCode }}"
