...
<head>
    ...
    <!-- site metas -->
    <title>{{ trans('main_trans.edit_profile') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.css') }}"
        media="screen">
<style>
    .shoes_price{
...
<body class="main-layout">
    ...
    <div class="collection_text">{{ trans('main_trans.edit_profile') }}</div>
                            ...
                            <div class="container">
                                    ...
                                    <div class="form-group">
                                        <form action="{{route('users.update',auth()->user()->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                        <input type="text" class="email-bt" placeholder="الاسم" name="name" value="{{auth()->user()->name}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="رقم الهاتف" name="phone" value="{{auth()->user()->phone}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="البريد الإلكتروني" name="email" value="{{auth()->user()->email}}">
                                    </div>

                            </div>
                            <div class="send_btn">
                                <button class="main_bt" type="submit">{{ trans('main_trans.save_edit') }}</button>
                            </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mail_section">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a href="tel:011354632"><div class="footer-logo"><img src="{{asset('images/phone-icon.png') }}"><span class="map_text">(+963)011354632</span>
                        </div></a>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                       <a href="mailto:eva@gmail.com"> <div class="footer-logo"><img src="{{asset('images/email-icon.png') }}"><span class="map_text">eva@gmail.com</span></div>
                    </div></a>
                    <div class="col-sm-6 col-lg-3">
...
</svg> <li class="pet_text">{{ trans('main_trans.delivery') }}</li><div>
                                <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-stars" viewBox="0 0 16 16">
  <path d="M7.657 6.247c.11-.33.576-.33.686 0l.645 1.937a2.89 2.89 0 0 0 1.829 1.828l1.936.645c.33.11.33.576 0 .686l-1.937.645a2.89 2.89 0 0 0-1.828 1.829l-.645 1.936a.361.361 0 0 1-.686 0l-.645-1.937a2.89 2.89 0 0 0-1.828-1.828l-1.937-.645a.361.361 0 0 1 0-.686l1.937-.645a2.89 2.89 0 0 0 1.828-1.828l.645-1.937zM3.794 1.148a.217.217 0 0 1 .412 0l.387 1.162c.173.518.579.924 1.097 1.097l1.162.387a.217.217 0 0 1 0 .412l-1.162.387A1.734 1.734 0 0 0 4.593 5.69l-.387 1.162a.217.217 0 0 1-.412 0L3.407 5.69A1.734 1.734 0 0 0 2.31 4.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387A1.734 1.734 0 0 0 3.407 2.31l.387-1.162zM10.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.156 1.156 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.156 1.156 0 0 0-.732-.732L9.1 2.137a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732L10.863.1z"/>
</svg> <li class="pet_text">{{ trans('main_trans.easy') }}</li><div>
                                 <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-stars" viewBox="0 0 16 16">
  <path d="M7.657 6.247c.11-.33.576-.33.686 0l.645 1.937a2.89 2.89 0 0 0 1.829 1.828l1.936.645c.33.11.33.576 0 .686l-1.937.645a2.89 2.89 0 0 0-1.828 1.829l-.645 1.936a.361.361 0 0 1-.686 0l-.645-1.937a2.89 2.89 0 0 0-1.828-1.828l-1.937-.645a.361.361 0 0 1 0-.686l1.937-.645a2.89 2.89 0 0 0 1.828-1.828l.645-1.937zM3.794 1.148a.217.217 0 0 1 .412 0l.387 1.162c.173.518.579.924 1.097 1.097l1.162.387a.217.217 0 0 1 0 .412l-1.162.387A1.734 1.734 0 0 0 4.593 5.69l-.387 1.162a.217.217 0 0 1-.412 0L3.407 5.69A1.734 1.734 0 0 0 2.31 4.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387A1.734 1.734 0 0 0 3.407 2.31l.387-1.162zM10.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.156 1.156 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.156 1.156 0 0 0-.732-.732L9.1 2.137a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732L10.863.1z"/>
</svg> <li class="pet_text">{{ trans('main_trans.save') }}</li><div>
                                 <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-stars" viewBox="0 0 16 16">
  <path d="M7.657 6.247c.11-.33.576-.33.686 0l.645 1.937a2.89 2.89 0 0 0 1.829 1.828l1.936.645c.33.11.33.576 0 .686l-1.937.645a2.89 2.89 0 0 0-1.828 1.829l-.645 1.936a.361.361 0 0 1-.686 0l-.645-1.937a2.89 2.89 0 0 0-1.828-1.828l-1.937-.645a.361.361 0 0 1 0-.686l1.937-.645a2.89 2.89 0 0 0 1.828-1.828l.645-1.937zM3.794 1.148a.217.217 0 0 1 .412 0l.387 1.162c.173.518.579.924 1.097 1.097l1.162.387a.217.217 0 0 1 0 .412l-1.162.387A1.734 1.734 0 0 0 4.593 5.69l-.387 1.162a.217.217 0 0 1-.412 0L3.407 5.69A1.734 1.734 0 0 0 2.31 4.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387A1.734 1.734 0 0 0 3.407 2.31l.387-1.162zM10.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.156 1.156 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.156 1.156 0 0 0-.732-.732L9.1 2.137a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732L10.863.1z"/>
</svg> <li class="pet_text">{{ trans('main_trans.speed') }}</li><div>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
...
</svg> <li class="pet_text">{{ trans('main_trans.children') }}</li><div>
                                <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-gem" viewBox="0 0 16 16">
  <path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/>
</svg> <li class="pet_text">{{ trans('main_trans.snek') }}</li><div>
                                <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-gem" viewBox="0 0 16 16">
  <path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/>
</svg> <li class="pet_text">{{ trans('main_trans.bats') }}</li><div>
                                <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-gem" viewBox="0 0 16 16">
  <path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/>
</svg> <li class="pet_text">{{ trans('main_trans.barges') }}</li><div>
</li><div>
                               <div class="image-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ff4e5b" class="bi bi-gem" viewBox="0 0 16 16">
  <path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/>
</svg> <li class="pet_text">{{ trans('main_trans.Shoes') }}</li><div>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- section footer end -->
    <div class="copyright">2023 .<a href="https://html.design">{{trans('main_trans.footer') }}</a></div>
