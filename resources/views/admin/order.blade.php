...
<head>
    <title>لوحة تحكم موقع إيفا - إدارة المبيعات </title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <h1 class="m-0">إدارة المبيعات</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">إدارة المبيعات</a></li>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('orders.destroy',$c->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
