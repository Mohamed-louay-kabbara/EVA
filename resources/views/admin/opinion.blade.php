...
<head>
    <title>لوحة تحكم موقع إيفا - إدارة التقييمات</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <h1 class="m-0">إدارة التقييمات</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">إدارة التقييمات</a></li>
                    ...
                    <table class="table table-bordered table-hover col-10 ml-5" id="table_id">
                        <thead>
                            <tr>
                                <th>اسم المستخدم</th>
                                <th>درجة التقييم</th>
                                <th>وقت و تاريخ التقييم</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($evalution as $e)
                            <tr>
                                <td>{{$e->user->name}}</td>
                                ...
                                @endif
                                <td>{{$e->created_at}}</td>
                                <td><button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete{{$e->id}}" data-bs-whatever="@mdo">حذف</button>
                                    <div class="modal fade" id="delete{{$e->id}}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('opinions.destroy',$e->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                ...
                <div class="row">
                    ...
                    <footer class="main-footer">
                        <strong>Copyright &copy; 2023-2024 <a href="https://eva.io">EVA.com</a>.</strong>
                        All rights reserved.
                    </footer>
                </div>
            </div>
