...
<head>
    ...
    <!-- site metas -->
    <title>{{ trans('main_trans.tit') }}</title>
    ...
    <div class="header_section">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <div class="logo">
                        <a href="#"><img src="{{ asset('images/logo03.png') }}" width="85px" height="85px"></a>
                    </div>
                </div>
                <div class="col-sm-9">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav" style="margin-left: -30px">
                                <a class="nav-item nav-link" style="font-size:15px" href="">{{ trans('main_trans.first') }}</a>
                                <a class="nav-item nav-link" style="font-size:15px" href="#category">{{ trans('main_trans.second') }}</a>
                                <a class="nav-item nav-link" style="font-size:15px" href="#contont">{{ trans('main_trans.third') }}</a>
                                <a class="nav-item nav-link" style="font-size:15px" href="#b">{{ trans('main_trans.fourthly') }}</a>
                                <div class="btn-group">
                                    <button type="button" style="color:#fff;font-size:13px;font-weight:bold;margin-right:-40px;margin-left:25px;margin-bottom:20px" class="btn btn-danger dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="btn-group">
                                    ...
                                    style="font-size:15px;font-weight:bold;margin-left:60px;margin-bottom:20px">
                                        @if (App::getLocale() == 'ar')  
                          ...
                          {{-- <a class="nav-item nav-link last" href="{{route('orders.create')}}"><img src="{{asset('images/shop_icon.png') }}"></a> --}}
...
<div class="banner_section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="banner_taital">
                                        <h1 class="banner_text" style="margin-left:-50px"> {{ trans('main_trans.shoes') }}
                                        </h1>
                                        <h1 class="mens_text"><strong>النساء تحب إيفا</strong></h1>
                                    </div>
                                </div>
                                <div class="col-sm-5">
    ...
    <div class="collection_section" id="category">
        <div class="container"><br>
            <h1 class="new_text text-center"><strong style="color:#ff4e5b; font-size:40px">{{ trans('main_trans.categories') }}</strong></h1>
            <h2 class="consectetur_text text-center" style="color: #6f42c1;font-size:25px">{{ trans('main_trans.title_1') }}</h2>
        </div>
    </div>
    <div class="collectipn_section_5 layuot_padding">
        @foreach ($category as $c)
        <div class="container">
            <div class="racing_shoes" style="margin-top:30px">
                <div class="row">
                    <div class="col-md-8">

                        <form action="{{ route('show_shoses') }}" method="get">
                            @csrf
                            <div class="shoes-img3"><button type="submit" style="margin-left:150px;font-size:22px;color:#6610f2;font-weight:bold">{{ trans('main_trans.shopping') }}</button>
                                <img src="{{ asset('imgs/' . $c->image) }}" style="width:40%; height: 40%">
                            </div>
                    </div>
                    <input type="hidden" name="id_category" value="{{ $c->id }}">
                    </form>
                    <div class="col-md-4">
                        <div class="sale_text m-5"><strong style="font-size:33px;">
                            @if (App::getLocale() == 'en')
                        {{ $c->name_en }}
                         @else
                          {{ $c->name_ar }} @endif
                        ...
                        <div class="number_text"><strong> <span style="color: #0a0506"></span></strong>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="layout_padding contact_section" id="contont">
        <div class="container">
            <h1 class="new_text" style="color:#fd4d5a; margin-left:35px; font-size:40px"><strong>{{ trans('main_trans.third') }} </strong></h1>
        </div>
            ...
            <div class="row">
                            ...
                            <div class="container">
                                <form action="/action_page.php">
                                    <div class="form-group">
                                        <h3 style="color:#6f42c1; margin-left:23rem;font-size:25px">{{ trans('main_trans.altal') }}</h3>
                                        <p style="color:#ff4e5b;font-size:18px">{{ trans('main_trans.dept_1') }}</p>
                                    </div>

                                    <div class="form-group">
                                        <h3 style="color:#6f42c1;  margin-left:23rem;font-size:25px">{{ trans('main_trans.barza') }}</h3>
                                        <p style="color:#ff4e5b;font-size:18px">{{ trans('main_trans.dept_2') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <h3 style="color:#6f42c1;  margin-left:23rem;font-size:25px">{{ trans('main_trans.haza') }}</h3>
                                        <p style="color:#ff4e5b;font-size:18px">{{ trans('main_trans.dept_3') }}</p>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="shop_banner">
                        <div class="our_shop" style="padding-bottom:40px">
                        </div>
                    </div>
                </div>
            </div>
